...
export class Page8 {
  ...
  constructor(public navCtrl: NavController) {
    ...
    /*
             ...
             stage, w, h, loader, pipe1height, pipe2height, pipe3height, startX, startY, wiggleDelta;
             background, bird, ground, pipe, bottomPipe, pipes, rotationDelta, counter, counterOutline;
             started = false; 
             startJump = false; // Has the jump started?

             jumpAmount = 120; // How high is the jump?
             jumpTime = 266;

             dead = false; // is the bird dead?
             KEYCODE_SPACE = 32;     //usefull keycode
             gap = 250;
             masterPipeDelay = 78; // delay between pipes
             pipeDelay = masterPipeDelay; //counter used to monitor delay
