...
export declare function getConfigValueDefault(argFullName: string, argShortName: string, envVarName: string, defaultValue: string, context: BuildContext): string;
...
export declare function getProcessEnvVar(key: string): string;
