...
var Logger = (function () {
    ...
    Logger.log = function () {
        ...
        var lines = Logger.wordWrap(msg.join(' '));
    ...
    Logger.wordWrap = function (text) {
        var output = [];
        var msgWords = text.toString().replace(/\s/gm, ' ').split(' ');
        var msgLine = '';
        msgWords.filter(function (m) { return m.length; }).forEach(function (m) {
            msgLine += m + ' ';
